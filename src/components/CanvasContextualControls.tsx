...
import {
  applyPageFrameSettingsPatch,
  resolvePageFrameSettings,
} from "@/lib/page-frame-settings";
import type {
  PageNumberSettings,
  TitleWordsSettings,
  WordSearchPuzzle,
...
import {
  CanvasEditTabsBar,
  type CanvasEditPanelTab,
} from "@/components/CanvasEditTabsBar";
...
export interface CanvasContextualControlsProps {
  ...
  /** floating = over canvas; sidebar = Document · This tab */
...
function CanvasEditActions({
  ...
  const showRangeSelect =
    showPageOnly && documentPuzzleCount > 1 && onCommitRange;
    ...
    <div className="canvas-context-panel__footer">
      ...
      {showRangeSelect && (
        <div className="canvas-context-panel__footer-range">
          <Label
            htmlFor="canvas-edit-range"
            className="canvas-context-panel__footer-range-label"
          >
            Range select
          </Label>
          <Input
          ...
          />
          {rangeError && (
            <p className="canvas-context-panel__footer-range-error">
              {rangeError}
            </p>
          )}
          <Button
...
export function CanvasContextualControls({
  ...
  const updatePageNumber = useCallback(
    (updates: Partial<PageNumberSettings>) => {
      onDraftSettingsChange((prev) => {
        const pageNumber = normalizePageNumberSettings(
          prev.typography.pageNumber,
        );
        return patchWordSearchSettings(prev, {
          typography: {
            pageNumber: normalizePageNumberSettings({
              ...pageNumber,
              ...updates,
            }),
          },
  ...
  const updatePageFrameSettings = useCallback(
    (updates: Parameters<typeof applyPageFrameSettingsPatch>[1]) => {
      onDraftSettingsChange((prev) =>
        patchWordSearchSettings(prev, applyPageFrameSettingsPatch(prev, updates)),
      );
    },
    [onDraftSettingsChange],
  );
  ...
  const updateHeaderAssembly = useCallback(
    (updates: Partial<HeaderAssemblySettings>) => {
      onDraftSettingsChange((prev) => {
        const current = normalizeHeaderAssemblySettings(
          prev.colors.puzzlePage.headerAssembly,
        );
        return patchWordSearchSettings(prev, {
          colors: {
            puzzlePage: {
  ...
  const headerAssembly = normalizeHeaderAssemblySettings(
    colors.puzzlePage.headerAssembly,
  );

  const puzzleContentLineIndex =
    currentPuzzle != null
      ? getPuzzleContentLineIndex(currentPuzzle, wordSearchSettings)
      : 0;
  ...
  const body = (
    <>
      {variant !== "sidebar" && editTabs && editTabs.length > 0 && (
        ...
        <div className="canvas-context-panel__section">
          ...
          {typography.selectTitleOption === "none" ? (
            <p className="text-xs text-slate-500 mb-2">
              Titles are turned off. Enable a title mode in the sidebar to edit
              title text.
            </p>
          ) : typography.selectTitleOption === "custom" ? (
            <SettingsTextInput
              className="h-8 text-xs mb-1"
              value={getRawContentLineAt(
            ...
            <SettingsTextInput
              ...
              onChange={(v) => updateTypography({ titleText: v })}
              placeholder="Title for all puzzles..."
            />
          )}
          {typography.selectTitleOption === "custom" && (
            <p className="text-xs text-slate-500 mb-3">
              Custom title for puzzle{" "}
              {currentPuzzle?.puzzleNumber ?? pageIndex + 1} only.
            </p>
          )}
          {typography.selectTitleOption !== "none" &&
            typography.selectTitleOption !== "custom" && (
              <p className="text-xs text-slate-500 mb-3">
                Same title on every puzzle page.
              </p>
            )}
          ...
          {typography.selectTitleOption !== "none" && (
            <>
              ...
              <Select
                value={typography.puzzleNumberingStyle || "none"}
                onValueChange={(value) =>
                  updateTypography({
                    puzzleNumberingStyle: value as "none" | "prefix" | "suffix",
                  })
                }
              >
          ...
          <Select
            ...
            onValueChange={(value) =>
              updateTypography({ puzzleTitleFontFamily: value })
            }
          >
            <SelectTrigger className="h-8 text-xs">
              <SelectValue />
          ...
          <Select
            value={
              typography.subtitleFontFamily || typography.puzzleTitleFontFamily
            }
            onValueChange={(value) =>
              updateTypography({ subtitleFontFamily: value })
            }
          ...
          {headerAssembly.enabled && (
            <Select
              value={
                headerAssembly.number.fontFamily ||
          ...
          <div className="canvas-context-panel__grid-2">
            <SliderField
              ...
              onValueChange={(v) =>
                updateTypography({ puzzleTitleFontSize: v })
              }
              min={0}
              max={50}
              step={1}
          ...
          <div className="canvas-context-panel__adjust-stack">
            <SliderField
          ...
          <div className="canvas-context-panel__card">
            <div className="flex items-center gap-2 mb-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  updateHeaderAssembly({ enabled: checked === true })
                }
              />
              <Label
                htmlFor="canvas-header-assembly"
                className="text-xs font-normal cursor-pointer"
              >
            ...
            {headerAssembly.enabled ? (
              <HeaderAssemblyEditor
                ...
                onTitleTextColorChange={(v) =>
                  updatePuzzlePageColors({ titleColor: v })
                }
                onSubtitleTextColorChange={(v) =>
                  updatePuzzlePageColors({ subtitleColor: v })
                }
              />
            ) : (
              <>
        ...
        <div className="canvas-context-panel__section">
          ...
          <div className="canvas-context-panel__direction-grid">
            <DirectionToggle
              label="Right"
              icon={ArrowRight}
              checked={core.allowRight}
              onCheckedChange={(v) => updateCore({ allowRight: v })}
            />
            <DirectionToggle
              label="Left"
              icon={ArrowLeft}
              checked={core.allowLeft}
              onCheckedChange={(v) => updateCore({ allowLeft: v })}
            />
            <DirectionToggle
              label="Down"
              icon={ArrowDown}
              checked={core.allowDown}
              onCheckedChange={(v) => updateCore({ allowDown: v })}
            />
            <DirectionToggle
              label="Up"
              icon={ArrowUp}
              checked={core.allowUp}
              onCheckedChange={(v) => updateCore({ allowUp: v })}
            />
            <DirectionToggle
              label="Diagonal down"
              icon={ArrowDownRight}
              checked={core.allowDiagonalDown}
              onCheckedChange={(v) => updateCore({ allowDiagonalDown: v })}
            />
            <DirectionToggle
              label="Diagonal up"
              icon={ArrowUpRight}
              checked={core.allowDiagonalUp}
              onCheckedChange={(v) => updateCore({ allowDiagonalUp: v })}
            />
            <DirectionToggle
              label="Diagonal down reverse"
              icon={ArrowUpLeft}
              checked={core.allowDiagonalDownReverse}
              onCheckedChange={(v) =>
                updateCore({ allowDiagonalDownReverse: v })
              }
            />
            <DirectionToggle
              label="Diagonal up reverse"
              icon={ArrowDownLeft}
              checked={core.allowDiagonalUpReverse}
              onCheckedChange={(v) => updateCore({ allowDiagonalUpReverse: v })}
            />
          </div>
          ...
          <Select
            ...
            onValueChange={(value) =>
              updateTypography({ puzzleGridFontFamily: value })
            }
          >
          ...
          <div className="canvas-context-panel__grid-2">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateTypography({
                    puzzleGridCase: value as "upper" | "lower",
                  })
                }
              >
                <SelectTrigger className="h-8 text-xs">
          ...
          <div className="canvas-context-panel__grid-2 mb-2">
            <MiniColorInput
              label="Text Fill"
              value={colors.puzzlePage.puzzleColor || "#1f2937"}
            ...
            <MiniColorInput
              ...
              onChange={(v) =>
                updatePuzzlePageColors({ puzzleLetterStrokeColor: v })
              }
            />
          </div>
          <SliderField
            ...
            onValueChange={(v) =>
              updatePuzzlePageColors({ puzzleLetterStrokeThickness: v })
            }
            min={0}
            max={8}
            step={0.5}
          ...
          <div className="flex items-center gap-2 mb-2">
            <Checkbox
              id="canvas-no-box-around-puzzle"
              checked={core.noBoxAroundPuzzle}
              onCheckedChange={(checked) =>
                updateCore({ noBoxAroundPuzzle: checked === true })
              }
            />
            <Label
              htmlFor="canvas-no-box-around-puzzle"
              className="text-xs font-normal cursor-pointer"
            >
              No Box Around Puzzle
            </Label>
          </div>
          <div className="canvas-context-panel__adjust-stack">
            <SliderField
              ...
              step={1}
              format="px"
              disabled={core.noBoxAroundPuzzle}
              control="popover"
            />
            <SliderField
              label="Corner Radius"
      ...
      {target === "word-list" && (
        <div className="canvas-context-panel__section">
          ...
          <Select
            ...
            onValueChange={(value) =>
              updateWordListSettings({ wordListFontFamily: value })
            }
          >
            <SelectTrigger className="h-8 text-xs mb-2">
              <SelectValue />
          ...
          <div className="canvas-context-panel__grid-2">
            <SliderField
              ...
              onValueChange={(v) =>
                updateWordListSettings({ wordListFontSize: v })
              }
              min={0}
              max={50}
              step={1}
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateWordListSettings({
                    wordListCase: value as "upper" | "lower" | "title",
                  })
                }
              >
                <SelectTrigger className="h-8 text-xs">
          ...
          <SliderField
            ...
            onValueChange={(v) =>
              updateTypography({ spaceBetweenPuzzleAndWordList: v })
            }
            min={0}
            max={100}
            step={1}
          ...
          <div className="canvas-context-panel__grid-2">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateWordListSettings({
                    wordListColumns: parseInt(value, 10),
                  })
                }
              >
                <SelectTrigger className="h-8 text-xs">
            ...
            <SliderField
              ...
              onValueChange={(v) =>
                updateWordListSettings({ wordSpacingHorizontal: v })
              }
              min={0}
              max={100}
              step={1}
            ...
            <SliderField
              ...
              onValueChange={(v) =>
                updateWordListSettings({ wordSpacingVertical: v })
              }
              min={0}
              max={40}
              step={1}
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  updateWordListSettings({ addCheckboxes: checked === true })
                }
              />
              <Label
                htmlFor="canvas-checkboxes"
                className="text-xs font-normal cursor-pointer"
              >
                Add checkboxes
              </Label>
            ...
            <div className="flex items-center gap-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  updateWordListSettings({ dontAlphabetize: checked === true })
                }
              />
              <Label
                htmlFor="canvas-no-alpha"
                className="text-xs font-normal cursor-pointer"
              >
                Don&apos;t alphabetize
              </Label>
        ...
        <div className="canvas-context-panel__section">
          <div className="flex items-center gap-2 mb-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                updatePageNumber({ enabled: !!checked })
              }
            />
            <Label
              htmlFor="canvas-page-number-enabled"
              className="text-xs font-normal cursor-pointer"
            >
              Show page number
            </Label>
            ...
            <>
              <div className="canvas-context-panel__grid-2">
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updatePageNumber({
                        startNumberingFrom: Number(e.target.value) || 1,
                      })
                    }
                  />
                </div>
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updatePageNumber({
                        startAtPage: Number(e.target.value) || 1,
                      })
                    }
                  />
                </div>
              ...
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updatePageNumber({
                      position: value as PageNumberSettings["position"],
                    })
                  }
                >
                  <SelectTrigger className="h-8 text-xs">
          ...
          <div className="canvas-context-panel__card space-y-3">
            <div className="flex items-center gap-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  updatePageFrameSettings({ enabled: !!checked })
                }
              />
              <Label
                htmlFor="canvas-page-frame-enabled"
                className="text-xs font-normal cursor-pointer"
              >
            ...
            {pageFrame.enabled && (
              <>
                <SliderField
                  ...
                  onValueChange={(v) =>
                    updatePageFrameSettings({ marginSizeIn: v })
                  }
                  min={0}
                  max={1}
                  step={0.0625}
                ...
                <div className="canvas-context-panel__adjust-stack">
                  <SliderField
                    ...
                    onValueChange={(v) =>
                      updatePageFrameSettings({ cornerRadiusPx: v })
                    }
                    min={0}
                    max={40}
                    step={1}
                  ...
                  <SliderField
                    ...
                    onValueChange={(v) =>
                      updatePageFrameSettings({ strokeThicknessPx: v })
                    }
                    min={0}
                    max={10}
                    step={1}
          ...
          {pageKind === "solution" ? (
            <>
              ...
              <CanvasBackgroundImageControl
                ...
                onImageChange={(base64) =>
                  updateAnswerPageColors({ backgroundImage: base64 })
                }
                onOpacityChange={(v) =>
                  updateAnswerPageColors({ backgroundImageOpacity: v })
                }
                onFitChange={(v) =>
                  updateAnswerPageColors({ backgroundImageFit: v })
                }
                onRemove={() =>
                  updateAnswerPageColors({ backgroundImage: undefined })
                }
              />
            </>
          ) : (
            <>
              ...
              <CanvasBackgroundImageControl
                ...
                onImageChange={(base64) =>
                  updatePuzzlePageColors({ backgroundImage: base64 })
                }
                onOpacityChange={(v) =>
                  updatePuzzlePageColors({ backgroundImageOpacity: v })
                }
                onFitChange={(v) =>
                  updatePuzzlePageColors({ backgroundImageFit: v })
                }
                onRemove={() =>
                  updatePuzzlePageColors({ backgroundImage: undefined })
                }
              />
            </>
          )}
      ...
      {target === "solution-title" && (
        <div className="canvas-context-panel__section">
          ...
          <Select
            ...
            onValueChange={(value) =>
              updateAnswerPageColors({ answerTitleFontFamily: value })
            }
          >
            <SelectTrigger className="h-8 text-xs mb-2">
              <SelectValue />
          ...
          <div className="canvas-context-panel__grid-2">
            <SliderField
              ...
              onValueChange={(v) =>
                updateAnswerPageColors({ answerTitleFontSize: v })
              }
              min={0}
              max={50}
              step={1}
          ...
          <Select
            ...
            onValueChange={(value) => {
              if (value === "same_as_puzzle") {
                updateTypography({
                  solutionTitleStyle: value as "same_as_puzzle" | "custom",
          ...
          {typography.solutionTitleStyle === "custom" && (
            <>
              <SettingsTextInput
                ...
                onChange={(v) =>
                  updateTypography({ customSolutionTitle: v })
                }
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateTypography({
                    solutionNumberingStyle: value as
                      "none" | "prefix" | "suffix",
                  })
                }
              >
        ...
        <div className="canvas-context-panel__section">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateBookCanvas({ answersPerPage: parseInt(value, 10) })
              }
            >
              <SelectTrigger className="h-8 text-xs">
                <SelectValue />
          ...
          <div className="canvas-context-panel__grid-2">
            ...
            <MiniColorInput
              ...
              onChange={(v) =>
                updateAnswerPageColors({ solutionHighlightStrokeColor: v })
              }
            />
          </div>
          <div className="canvas-context-panel__adjust-stack">
            <SliderField
              ...
              onValueChange={(v) =>
                updateAnswerPageColors({ solutionStrokeThickness: v })
              }
              min={0}
              max={30}
              step={1}
            ...
            <SliderField
              ...
              onValueChange={(v) =>
                updateAnswerPageColors({ solutionHighlightAlpha: v })
              }
              min={0}
              max={100}
              step={1}
          ...
          <div className="canvas-context-panel__adjust-stack">
            <SliderField
              label="Border thickness"
              value={
                core.solutionBorderStrokeThickness ?? core.borderStrokeThickness
              }
              onValueChange={(v) =>
                updateCore({ solutionBorderStrokeThickness: v })
              }
              min={0}
              max={10}
              step={1}
            ...
            <SliderField
              ...
              onValueChange={(v) =>
                updateCore({ solutionBorderCornerRadius: v })
              }
              min={0}
              max={40}
              step={1}
            ...
            <SliderField
              ...
              onValueChange={(v) =>
                updateCore({ solutionGridBorderPadding: v })
              }
              min={0}
              max={40}
              step={1}
